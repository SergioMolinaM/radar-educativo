...
export default function SemaforoLeyenda({ compact = false }) {
  if (compact) {
    return (
      <span style={{ fontSize: 11, color: 'var(--text-muted)' }}>
        <span style={{ color: '#ef4444' }}>●</span> Crítico &lt;75%
        {' · '}<span style={{ color: '#f59e0b' }}>●</span> Atención 75-82%
  ...
  return (
    <div style={{
      ...
      <span><span style={{ color: '#ef4444', fontSize: 14 }}>●</span> <strong>Rojo</strong> — Asistencia bajo 75%. Requiere acción inmediata.</span>
